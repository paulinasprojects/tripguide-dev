  ...
  return (
    <>
      {trendingCitiesData.map((city) => (
        <div key={city.id} className="bg-white rounded-[16px] md:w-[470px] md:h-[215px] max-sm:w-[370px] max-sm:h-[221px]">
          <div className="flex  gap-[30px] mt-[23px] ml-[24px]">
            ...
            <div className="flex flex-col gap-2.5">
              <span className="font-bold text-headlineFour font-dm-sans">{city.title}</span>
              ...
              <div className="">
                <button className="bg-blue80 rounded-[8px] text-white w-[99px] h-[33px] text-md font-bold font-dm-sans">Book now</button>
              </div>
            </div>
          </div>
        </div>
