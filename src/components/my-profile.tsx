...
const MyProfile = () => {
  return (
    <div className="bg-white rounded-[10px] w-[334px] h-[551px]">
      <div className="px-[25px] py-[31px]">
        <div className='relative pl-[62px]'>
          <Image
            ...
            alt='image'
          />
          <div className='absolute bottom-0 right-16 bg-[#F4F5F6] rounded-full size-10 border-[2px] border-[#E7ECF3] cursor-pointer'>
            <Pencil className='size-5 mt-2 ml-2'/>
          </div>
        </div>
        <div className='flex flex-col items-center gap-[24px] mt-5'>
          <span className='text-headlineThree font-bold font-dm-sans'>Johnatan Doe</span>
          <span className='flex items-center gap-2 text-[#777E90] text-sm font-normal font-dm-sans bg-[#F4F5F6] rounded-[32px] px-8 py-2.5'>
        ...
        <div className='mt-[47px] ml-2'>
          <button className='flex items-center justify-center gap-[13px] bg-[#878CFF] rounded-[20px] px-20 py-2 text-[12px] text-white font-medium font-font-roboto'>
            Edit My Data
