    ...
    <div className="bg-white rounded-[10px]">
      <div className="px-[25px] py-[31px]">
        ...
        <div className='mt-[47px] ml-2'>
          <button className='flex items-center justify-center gap-[13px] bg-[#878CFF] rounded-[20px] xl:px-20 lg:px-5 md:px-5 max-sm:px-28 py-2 text-[12px] text-white font-medium font-font-roboto hover:bg-[#9ea3f7]'>
            Edit My Data
