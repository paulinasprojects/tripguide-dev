const TopTourCard = () => {
  return (
    <div className='flex md:flex-row xl:gap-[30px] lg:gap-5 md:gap-5 items-center justify-center mt-[50px] max-sm:flex-col max-sm:gap-5'>
      <div className="relative">
        <img src="https://res.cloudinary.com/dymlzmyuo/image/upload/v1729963616/tokyo_so1nui.jpg" alt="" className="xl:w-[370px] md:w-[300px] xl:h-[495px] md:h-[408px] max-sm:h-[495px] max-sm:w-[335px] rounded-[20px] object-cover" />
      ...
      <div className="relative">
        <img src="https://res.cloudinary.com/dymlzmyuo/image/upload/v1729963617/barcelona_o3go0f.jpg" alt="" className="xl:w-[370px] md:w-[300px] xl:h-[495px] md:h-[408px] max-sm:h-[495px] max-sm:w-[335px]  rounded-[20px] object-cover" />
      ...
      <div className="relative">
        <img src="https://res.cloudinary.com/dymlzmyuo/image/upload/v1730106716/bali_g343kz.jpg" alt="" className="xl:w-[370px] md:w-[300px] xl:h-[495px] md:h-[408px] max-sm:h-[495px] max-sm:w-[335px]  rounded-[20px] object-cover" />
